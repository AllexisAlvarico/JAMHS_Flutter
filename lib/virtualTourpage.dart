...
class _VirutalToursPageState extends State<VirutalToursPage> {
  ...
  List<ArtifactArticlesData> data = [
    ...
    ArtifactArticlesData(
        "assets/images/henry_heller.jpg",
        "Henry Heller\nMedal of Honor Recipient",
        "Henry Heller",
        "Medal of Honor Recipient",
        "Sergeant Henry Heller\n\nSergeant, Company A, 66th Ohio Infantry.  One of a party of four who, under heavy fire, voluntarily brought into the Union lines a wounded Confederate officer from whom was obtained valuable information concerning the position of the enemy.\n\nBetween the flaming lines at Chancellorsville, lay a wounded enemy, courageously trying to suppress the cries welling to his lips, through the pain of a gaping wound.  A party of four suddenly rushed without orders from the Union lines and under a heavy fire brought him back.  One of this brave group was Henry Heller, a Sergeant of Company “A”, of the 66th Ohio Infantry.  Later the wounded man who was a Confederate officer gave much valuable information to Heller’s superiors concerning enemy positions which had much to do with the result of the battle.  At the time there was no thought in the minds of the brave little party as to the good that might result.  They could only see a brave enemy soldier, exposed to the fire of both sides, who needed succor.  At the risk of their own lives, they went to his rescue. \n\nCitation: \n\nOne of a party of four who, under heavy fire, voluntarily brought into the Union lines a wounded Confederate officer from whom was obtained valuable information concerning the positions of the enemy.\n\nAction: MAY 2, 1863, Chancellorsville, Virginia\n\nNational Museum of American Jewish Military History (NMAJMH) does not recognize Henry Heller as Jewish.  They contend that he is buried in a Baptist cemetery (Kings Creek Baptist Church Cemetery, Kingscreek, OH). Simon Wolf lists Heller in his book The American Jew as Patriot, Soldier, and Citizen.  Sydney Gumpertz also lists Heller in his book The Jewish Legion of Valor indicating that according to them both he was Jewish. \n\nIn addition the National Museum of American Jewish Military History (NMAJMH) does not recognize Abraham Greenwalt as Jewish.  They contend that in the book A Standard History of Kansas and Kansans, 1919, in a biography of Abraham’s son Emor, states that Abraham, “is a member of the Methodist Church.”"),
  ];
